...
```{r}
plot_exceedances(exc_cities[exc_cities$aggregation_period=='8-hour',], average_by='week')
```
...
```{r}
plot_exceedances(exc_cities[exc_cities$standard_org=='EU',], average_by='week')
```
Plot only exceedances happening last week
```{r}
plot_exceedances(exc_cities[exc_cities$date >= Sys.Date()-7 , ], average_by='day')
```
